...
После скачивания и установки плагина, переходим в «Настройки»->»Вход через Яндекс» и заполняем обязательные поля ClientID и Client secret, а также выбираем тип отображения на сайте. Доступны следующие варианты:
